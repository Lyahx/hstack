...
Open a todolist whose first item is to read the Principles section of the **poteto-mode** skill (`/pstack:poteto-mode`, or `${CLAUDE_PLUGIN_ROOT}/skills/poteto-mode/SKILL.md`). Then add the phases below as todos.
